		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					...
					<div class="alert alert-success" role="alert">Haz ingresado como <%= request.getSession().getAttribute("nickname") %>.</div>
						<div class="row p-5">
							<div class="col-md-6">
								<img
						...
						<div>Hola <%= request.getSession().getAttribute("nickname") %>, inserta tus datos nuevamente porque no guardamos nada de lo que nos das</div>
						<div
							style="margin: 0 auto; padding-left: 20px; padding-right: 20px;">
							<form action="ingresoValores" method="POST">
								<div class="row">
									<div class="col-sm">
